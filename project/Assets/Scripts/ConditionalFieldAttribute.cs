...
#if UNITY_EDITOR
namespace CustomEditor.Internal
{
	using UnityEditor;
	...
	public class ConditionalFieldAttributeDrawer : PropertyDrawer
	{
		...
		private void GetTypeDrawerType(SerializedProperty property)
		{
			...
			try
			{
				_genericTypeDrawerType.GetField("m_Attribute", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(_genericTypeDrawerInstance, fieldInfo);
			}
			catch (Exception)
			{
